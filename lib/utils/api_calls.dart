...
class ApiCalls {
  ...
  static Future<List<MarketListModel>> getMarketList(int pageKey, String searchedWord, String selectedClass, String selectedIndustry, String selectedCurrency,) async {
    try {
      ...
      var url = Uri.https(
        EndPoints.baseUrl.replaceAll('/client_portal_api/', '').replaceAll('https://', ''),
        '/client_portal_api/markets',params
      );
  ...
  static Future<List<PositionModel>> getPositionList(int pageKey,int portfolioId) async {
    try{
    var url = Uri.parse(
        '${EndPoints.portfolios}/$portfolioId/portfolio_securities?page=$pageKey',
      );
